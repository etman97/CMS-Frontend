...
export class TwoImages {
  protected readonly sections = [
    {
      title: 'Intelligent Backup',
      images: [
        {
          src: 'https://www.figma.com/api/mcp/asset/6cd42718-f4a7-4475-950c-b378c9b85d42',
          alt: 'Cloud backup technology portal',
        },
        {
          src: 'https://www.figma.com/api/mcp/asset/4013923e-d7fa-42df-bb91-8719fe3dd841',
          alt: 'Cloud data backup on a laptop',
        },
      ],
      paragraphs: [
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://www.figma.com/api/mcp/asset/796717a3-e087-47bc-baec-c42db75d5491',
          alt: 'SaaS application backup concept',
        },
        {
          src: 'https://www.figma.com/api/mcp/asset/2d640bc8-df92-44ce-8b56-1e283670a86f',
          alt: 'Cloud service data visualization',
        },
      ],
      paragraphs: [
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://www.figma.com/api/mcp/asset/9954c24c-97e6-425d-bac9-1599c4a6bba5',
          alt: 'Resilient data network visualization',
        },
        {
          src: 'https://www.figma.com/api/mcp/asset/fc9f213d-c2d8-490f-ac2d-6e8b5c6d6126',
          alt: 'Data monitoring operations screen',
        },
      ],
      paragraphs: [
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://www.figma.com/api/mcp/asset/8e405bea-5f8d-432f-8150-55344f58af06',
          alt: 'Enterprise data storage racks',
        },
        {
          src: 'https://www.figma.com/api/mcp/asset/1c646814-72b7-46cf-b449-de86e946e1f5',
          alt: 'Storage interface controlled from a tablet',
        },
      ],
      paragraphs: [
    ...
    },
    {
      ...
      images: [
        {
          src: 'https://www.figma.com/api/mcp/asset/78ffeaba-2c4b-4d33-ab59-c4adc41185ae',
          alt: 'High availability and disaster recovery security shield',
        },
        {
          src: 'https://www.figma.com/api/mcp/asset/1d30acb8-72c2-4136-acfa-c02aa043049e',
          alt: 'Business continuity verification interface',
        },
      ],
      paragraphs: [
